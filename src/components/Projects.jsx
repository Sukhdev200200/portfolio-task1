...
const Projects = () => {
  ...
  return (
   <section className='my-20 w-full flex flex-col gap-5 align-center max-w-5xl mx-auto  '>
    ...
    <a href="https://github.com/Sukhdev200200/TO-D0.git"><h1 className='font-bold pl-48 ml-64 mb-3 text-2xl text-cyan-500 hover:underline hover:text-cyan-700 '>TO-DO LIST</h1></a>
